...
long int  (*distance)(long int, long int, struct problem*);  /* function pointer */
/*    
...
long int round_distance (long int i, long int j, struct problem *instance)
/*    
...
long int ceil_distance (long int i, long int j, struct problem *instance) 
/*    
...
long int geo_distance (long int i, long int j, struct problem *instance) 
/*    
...
long int att_distance (long int i, long int j, struct problem *instance) 
/*    
...
long int toroid_distance (long int i, long int j, struct problem *instance)
/*
...
long int ** compute_distances(struct problem *instance, int n)
/*    
...
*/
{
	...
	for ( j = 0  ; j < n ; j++ ) {
	    matrix[i][j] = distance(i, j, instance);
	}
    }
    return matrix;
}
...
long int ** compute_nn_lists( struct problem* instance, int n, struct ant_hyper_parameters *ant_hyper, struct ls_parameters *ls_params)
/*    
...
*/
{
    ...
    nn = MAX(ls_params->nn_ls, ant_hyper->nn_ants);
    if ( nn >= n ) 
	nn = n - 1;
    assert( n > nn );
...
long int compute_tour_length( long int *t, struct problem *instance, int n)
/*    
